...
import { deleteCommentAction, toggleCommentReactionAction } from "@/app/posts/actions";
...
export default async function PostPage({ params }: Props) {
  ...
  const [post, comments] = await Promise.all([getPost(user.id, id), listComments(user.id, id)]);
  if (!post) notFound();
