...
> **Status: steps 0–9 done 2026-09-14; Knit is live at
> `https://knit.marzipan-solutions.com`.** Kit's admin account exists; the backup is
> installed and proven by hand; §9 invite, reset, and assistant checks passed with a
> throwaway member (deleted). Still open: Kit's phone check and the first scheduled
> backup. Written from fantasy-football's `deploy/BOOTSTRAP.md`, which
